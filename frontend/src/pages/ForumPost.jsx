...
function AuthorCard({ username, role, size = 'sm' }) {
  ...
  return (
    <div className={`flex items-center gap-2 ${size === 'lg' ? '' : ''}`}>
      <div className={`${size === 'lg' ? 'w-10 h-10 text-base' : 'w-8 h-8 text-xs'} bg-bg3 border border-border flex items-center justify-center font-condensed font-black text-cyan flex-shrink-0`}>
        {initials}
      </div>
      <div>
      ...
      <div className="bg-bg2 border border-border mb-1">
        ...
        <div className="px-6 pt-5 pb-4 border-b border-border flex items-start justify-between gap-4">
          <div className="flex-1">
            <div className="font-condensed font-black text-3xl uppercase tracking-wide leading-tight mb-3">{post.title}</div>
          ...
          <div className="text-right flex-shrink-0">
            <div className="font-mono text-xs text-muted2 mb-1">Автор</div>
        ...
        {/* Post footer */}
        <div className="px-6 py-3 border-t border-border bg-bg3/30 font-mono text-xs text-muted2">
        ...
        <div className="mt-1 flex flex-col gap-px bg-border mb-1">
          {replies.map((r, i) => (
            <div key={r.id} className="bg-bg2 flex">
              ...
              <div className="flex-1">
                {/* Reply header */}
                <div className="px-5 pt-4 pb-3 border-b border-border flex items-center justify-between gap-4">
